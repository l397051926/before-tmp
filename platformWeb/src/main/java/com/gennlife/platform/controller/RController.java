...
public class RController {
    ...
    public
    @ResponseBody
    String postr_run(HttpServletRequest paramRe) {
    ...
    public
    @ResponseBody
    String postr_stop(HttpServletRequest paramRe) {
        Long start = System.currentTimeMillis();
        String resultStr = null;
        try {
            String param = ParamUtils.getParam(paramRe);
    ...
    public
    @ResponseBody
    String postr_save(HttpServletRequest paramRe) {
        Long start = System.currentTimeMillis();
        String resultStr = null;
        try {
            String param = ParamUtils.getParam(paramRe);
    ...
    public
    @ResponseBody
    String postr_load(HttpServletRequest paramRe) {
        Long start = System.currentTimeMillis();
        String resultStr = null;
        try {
            String param = ParamUtils.getParam(paramRe);
    ...
    public
    @ResponseBody
    String postr_list(HttpServletRequest paramRe) {
        Long start = System.currentTimeMillis();
        String resultStr = null;
        try {
            String param = ParamUtils.getParam(paramRe);
