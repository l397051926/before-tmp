...
public class UserProcessor {
    ...
    public void login(HttpServletRequest request, HttpServletResponse resps) throws IOException {
        ...
        viewer.viewString(jsonString, resps, request);
    }

    public void update(HttpServletRequest request, HttpServletResponse resps) throws IOException {
        String param = ParamUtils.getParam(request);
        boolean flag = true;
        SyUser user1 = null;
        try{
    ...
    public void changePwdSender(HttpServletRequest request, HttpServletResponse resps) throws IOException {
        boolean flag = true;
        try{
            String param = ParamUtils.getParam(request);
            logger.info("changePwdSender param ="+param);
            JsonObject jsonObject = jsonParser.parse(param).getAsJsonObject();
        ...
        String jsonString = gson.toJson(resultBean);
        viewer.viewString(jsonString, resps, request);
