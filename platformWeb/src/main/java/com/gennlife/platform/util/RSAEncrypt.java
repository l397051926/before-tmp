...
//        System.out.println(message + "\t加密后的字符串为:" + messageEn);
        String str = "VDIAOB7BLmko1yVthHms0gUNIGoPDKqNlcutV4yYJBBc/MFZELETrRezXVt9/rW8ODsu/xLxPTKQlhgohvmntw==";
        String messageDe = decrypt(str);
        System.out.println("还原后的字符串为:" + messageDe);


//        String urlEncoderString = Part3Processor.getURLEncoderString("VDIAOB7BLmko1yVthHms0gUNIGoPDKqNlcutV4yYJBBc/MFZELETrRezXVt9/rW8ODsu/xLxPTKQlhgohvmntw==");
//        System.out.println("sss:" + urlEncoderString);
    }
